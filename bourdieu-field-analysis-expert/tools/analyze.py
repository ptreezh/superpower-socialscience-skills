#!/usr/bin/env python3
"""
bourdieu-field-analysis-expert - 主分析入口
布迪厄场域分析专家技能
...
class SkillExpert:
    """
    bourdieu-field-analysis-expert 专家类
    ...
    def _format_output(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.detail_level == 1:
            ...
            return {
                ...
                'skill': result.get('skill', 'bourdieu-field-analysis-expert'),
    ...
    def _generate_summary(self, result: Dict[str, Any]) -> str:
        """生成摘要"""
        return f"bourdieu-field-analysis-expert 分析完成. "
