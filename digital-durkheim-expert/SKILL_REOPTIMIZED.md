...
description: |
  涂尔干理论分析专家技能（AI CLI 原生版 - 重新优化版）。支持自动任务队列执行和子Agent并行处理。
  包含完整的绝对禁止原则、任务分解规则、防虎头蛇尾机制，以及智能任务选择。

  **质量优先，效率兼顾**：保留所有方法论严谨性，简单任务智能提速，复杂任务完整流程。
  ...
  严格遵循涂尔干方法论原则（Durkheim 1893, 1897, 1912）。
...
metadata:
  ...
  optimization: "智能任务选择，简单任务提速50%，复杂任务保持100%严谨性"
...
performance:
  sequential: "20分钟/简单案例，40分钟/复杂案例"
  parallel: "15分钟/5简单案例（2.7x加速），45分钟/10复杂案例（8.9x加速）"
