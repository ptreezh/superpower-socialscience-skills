...
# PlanningFilesManager not available - commented out import
# from tools.planning_integration import PlanningFilesManager


class SkillExpert:
    """
    msqca-analysis-expert 专家类
    ...
    def _format_output(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.detail_level == 1:
            ...
            return {
                ...
                "skill": result.get("skill", "msqca-analysis-expert"),
    ...
    def _generate_summary(self, result: Dict[str, Any]) -> str:
        """生成摘要"""
        return f"msqca-analysis-expert 分析完成. "
