...
# 技能描述
skill_descriptions = {
    'bourdieu-field-analysis-expert': '布迪厄场域分析专家技能',
...
for skill_name in skills_to_update:
    ...
    print(f"✅ Updated analyze.py for {skill_name} (with progressive disclosure)")

print("\n✅ Batch update completed!")
print(f"Total skills updated: {len(skills_to_update)}")
print("\n新增功能:")
print("1. ✅ detail_level 参数控制 (1=摘要，2=标准, 3=详细)")
print("2. ✅ 三种输出模式")
print("3. ✅ 分阶段输出设计 (phased_output)")
